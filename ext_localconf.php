...
$TYPO3_CONF_VARS['SC_OPTIONS']['tce']['formevals']['tx_thrating_unlinkDynCss_eval'] = 'EXT:th_rating/Resources/Private/PHP/BE.tx_thrating_unlinkDynCss_eval.php';
//add hook to remove the dynamic CSS file when cache is cleared
$TYPO3_CONF_VARS['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['clearCachePostProc'][]='EXT:th_rating/Resources/Private/PHP/BE.userFunc.php:&user_BEfunc->clearCachePostProc';
